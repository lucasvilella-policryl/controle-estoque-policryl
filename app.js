...
function atualizarTabelaProdutosDashboard() {
    ...
    produtosOrdenados.forEach(produto => {
        ...
        tr.innerHTML = `
            <td><img src="${produto.fotoUrl || 'img/placeholder.png'}" class="produto-img" alt="${produto.descricao}"></td>
            <td>${produto.sku}</td>
...
function atualizarMovimentacoes() {
    ...
    movimentacoes.forEach(movimentacao => {
        ...
        tr.innerHTML = `
            <td>${dataFormatada}</td>
            <td>${horaFormatada}</td>
            <td><img src="${movimentacao.fotoUrl || 'img/placeholder.png'}" class="produto-img" alt="${movimentacao.descricao}"></td>
...
function cadastrarProduto() {
    ...
    if (fotoFile) {
        ...
        produto.fotoUrl = 'img/placeholder.png';
        salvarProduto(produto);
    }
}
